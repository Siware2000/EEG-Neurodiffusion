...
EEG-Neurodiffusion is a diffusion-based generative modeling framework for EEG topographic representations (EEG topomaps) and EEG-derived images, with applications in data augmentation, cross-subject generalization, and cognitive state classification.
...
The framework is designed to study when diffusion helps, when it hurts, and how quality control mechanisms mitigate negative transfer.
...
- Frozen-checkpoint ablation protocol  
- Vision Transformer (ViT) downstream classifier  
- Journal-grade statistical and interpretability analysis  
...
│ ├── journal_outputs/ # CSV outputs from evaluation scripts
...
- No validation or test data leakage
